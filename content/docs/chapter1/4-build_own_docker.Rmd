...
title: "Build your own docker image based on tidywearable"
...
```
FROM jaspershen/tidywearable:latest
...
RUN R -e "remotes::install_gitlab('jaspershen/tidywearable')"
```
...
## Use the `docker tag` command to give the `tidywearable` image a new name
...
How to pull docker image and run it can [refer this document](https://tidywearable.github.io/tidywearable/articles/docker.html).
